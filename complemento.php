...
<html>
<head>
	<title>Complementos - Comunicação Alternativa</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="prancha_externa">
		<div class="prancha_interna">
			<div class="prancha_ambiente">
				<img src="assets/images/ambientes/casa.png" border="0">
			</div>
			<div class="prancha_sujeito">
				<img src="assets/images/ambientes/sujeitos/avos.png" border="0">
			</div>
			<div class="prancha_verbo">
				<img src="assets/images/ambientes/verbos/assistir.png" border="0">
			</div>
	...
	<div class="area_figuras">
		<div class="figura_1">
			<a href="visualizacao.php">
				<img src="assets/images/ambientes/complementos/tomar_banho.png">
			</a>
		</div>
		<div class="figura_2">
			<a href="visualizacao.php">
				<img src="assets/images/ambientes/complementos/comer.png">
			</a>
		</div>
		<div class="figura_3">
			<a href="visualizacao.php">
				<img src="assets/images/ambientes/complementos/agua.png">
			</a>
		</div>
		<div class="figura_4">
			<a href="visualizacao.php">
				<img src="assets/images/ambientes/complementos/tv.png">
			</a>
		</div>
	</div>
